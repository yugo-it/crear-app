		...
		<div class="panel-body">
			<div class="task" >
				<table class="add-task">
					<tr>
						<td>Minimo:</td>
						<td><input type="text" ng-model="minimo"/></td>
					</tr>
					<tr>
						<td>Maximo:</td>
						<td><input type="text" ng-model="maximo"/></td>
					</tr>
					<tr>
						<td>Periodicidad:</td>
						<td>
							<select ng-model="periodicidad" ng-options="periodicidad as periodicidad for periodicidad in periodicidades">
					...
					<tr>
						<td>Medio Alerta:</td>
						<td>
							<select ng-model="medioAlerta" ng-options="medioAlerta as medioAlerta for medioAlerta in medioAlertaes">
								<option value="">-- Select --</option>
							</select>
						</td>
					</tr>
					<tr>
						<td><br/><button ng-click="addTask()" class="btn-panel-big">Agregar objetivo</button></td>
					</tr>
				</table>								
			</div>
		</div>
